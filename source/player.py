...
class Player(pygame.sprite.Sprite):
    ...
    def update_position(self, rocks, playerGroup, enemyGroup, plates):
        ...
        self.__checkRockCollision(hit_rock, rocks, interact_flag, old_position, keys, enemyGroup)
    ...
    def __checkRockCollision(self, hit_rock, rocks, inter_f, old_p, k, eg):
        ...
        if hit_rock:
            ...
            if self.has_belt and self.push_timer <= 0:
                ...
                if k[K_LSHIFT]:
                    ...
                    hit_rock[0].getMovedP(rocks, self.momentum, self, eg)
    ...
    def __updateComp(self, r, eg):
        ...
        if self.hasFriend == True:
            ...
            self.companion_group.update(self, r, eg)
